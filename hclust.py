...
if __name__ == '__main__':
    ...
    #ipt_data = pd.read_csv('C:/python/Ni/data/arc.csv', header='infer')
    #ipt_data = pd.read_csv('iris.csv', header='infer')
    # print(mdata)
    #X = ipt_data.iloc[:, 3:23].values
    #Y = ipt_data.iloc[:, 23].values

    ipt_data =  'berek.csv' #  'iris.dat'  # sys.argv[1]     # input data, e.g. iris.dat
